...
import AdminOrderCard from "@/components/cards/adminOrder/AdminOrderCard";

/**
 * @title Admin Order Component
 * @returns The Admin Order component
 */
const AdminOrder = ({ orders_ }: { orders_: Array<IOrder> }) => {
