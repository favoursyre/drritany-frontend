    ...
    return (
        ...
        <div className={styles.terms_body}>
            ...
            <ol>
                ...
                <li>Product Orders: When you place an order for a product on our website, delivery is fee. You are only responsible for all applicable taxes associated with your purchase as required in your jurisdiction of residence area.</li>
