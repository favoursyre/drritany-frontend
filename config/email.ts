...
We are pleased to inform you that your order was processed successfully. Our team is currently reviewing your order so that it can be fulfilled properly.
...
/**
 * @notice This sends an email for updated delivery status order to a customer
 * @param order The details of the order
 * @param body The body message of the email to be sent
 * @returns The status of the sent email, whether successful or not
 */
export const sendPaymentStatusEmail = (order: IOrder): any => {
    const template: string = `
    <!DOCTYPE html>
  <html lang="en">
    <head>
...
We are pleased to inform you that the payment status of your Order ${domainName}/order/receipt/${order._id} has been updated to '${order.paymentSpec.status}'.

If you ever have any questions, feel free to reply to this email. We value your feedback immensely.
...
${companyName} Inc.
    ...
    const status = sendEmail(`${companyName}`, SUPPORT_EMAIL, SUPPORT_PASSWORD, order.customerSpec.email, `Delivery Status`, body, undefined, undefined)
    return status
}
 ...
 * @returns The status of the sent email, whether successful or not
 */
export const sendDeliveryStatusEmail = (order: IOrder): any => {
    const template: string = `
    <!DOCTYPE html>
  <html lang="en">
    <head>
...
We are pleased to inform you that the delivery status of your Order ${domainName}/order/receipt/${order._id} has been updated to '${order.deliverySpec.status}'.
