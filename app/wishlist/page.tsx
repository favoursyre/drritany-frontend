...
export default async function CartPage() {
  ...
  return (
    <main className="cart_page">
      <ProductSlide _products={undefined} _product={undefined} title_={titles1} view_={"wishSlide1"}/>
      {/* <HomeCampaignB /> */}
      <ProductSlide _products={products} _product={undefined} title_={titles2} view_={"wishSlide2"}/>
    </main>
  )
}
